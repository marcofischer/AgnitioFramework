 ...
 * Will save the slideshows to localStorage.
 * Provides and API to help create a user interface
...
(function() {
  ...
  DynamicAgenda.prototype = {
    ...
    /* === MODEL === */
    // Add slideshows to app from localStorage data
    updateApp: function() {
    ...
    // Get the array of slides for a slideshow
    ...
    // ID will be DA_[timestamp in ms]
    create: function() {
    ...
    // Delete a slideshow
    // Will remove from data object and update localStorage
