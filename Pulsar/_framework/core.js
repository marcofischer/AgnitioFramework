...
(function() {
  var AutoMenu, Collection, InlineScroller, MemoryManager, Presentation, Slidescroller, Slideshow, View, d, lastSlide, _ref,
  ...
  window.Slideshow = Slideshow = (function() {
    ...
    Slideshow.prototype._scroll = function(nr, skipExit) {
      ...
      this.ele.style.cssText += prefix + 'transform:translate3d(' + x + 'px, ' + y + 'px, 0px);';
      this._setCurrent(nr);
    ...
    Slideshow.prototype.onLoad = function(inline) {
      ...
      this._createMarkup();
      this.ele.style.cssText = "width:" + this.width + "px;" + prefix + "transform:translate3d(0px, 0px, 0px);";
  ...
  window.Collection = Collection = (function(_super) {
    ...
    Collection.prototype._resetSection = function() {
      ...
      ss = app.slideshow;
      return setTimeout(function() {
        ss.ele.style.cssText += prefix + 'transform:translate3d(0px, 0px, 0px);';
    ...
    Collection.prototype.onUnload = function() {
      var collection, currentSlide, section, _i, _len, _ref1, _results;
  ...
  window.AutoMenu = AutoMenu = (function() {
    ...
    AutoMenu.prototype._init = function() {
      ...
      document.addEventListener('contentLoad', function() {
        var _ref1;
        if (_ref1 = app.loaded.id, __indexOf.call(_this.attachTo, _ref1) >= 0) {
    ...
    AutoMenu.prototype._build = function() {
      var aClass, aLink, classname, link, linkConfig, markup, name, pClass, pLink, skip, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2, _ref3;
      markup = '';
      if (this.prepend) {
        _ref1 = this.prepend;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
