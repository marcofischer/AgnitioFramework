  ...
  Menu.prototype = {
    ...
    _setCurrent:function () {
      ...
      if (link) {
        ...
        var menuPos = util.getPosition(currentMenu.ele);
        ...
        var appWidth = currentMenu.ele.getBoundingClientRect().width;

        if (rightPos >= appWidth) {
          toMove = (rightPos - appWidth) - currentMenu.offset - menuPos[0];
          ...
          toMove = pos - currentMenu.offset - menuPos[0];
          currentMenu.list.style.webkitTransitionDuration = '0.5s';
          currentMenu.list.style.webkitTransform = 'translate3d(-' + toMove + 'px, 0, 0)';
